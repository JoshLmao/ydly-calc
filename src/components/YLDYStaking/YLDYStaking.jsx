    ...
    if (this.state.algoAddress && !this.state.fetchingUsrVars) {
      ...
      getUserStateValues(
        ...
        (data) => {
          if (data) {
            console.log(
              `Successfully got user variables from application '${this.state.applicationID}' on address '${this.state.algoAddress}'`
            );
            this.setState(
              {
            ...
            this.setState({
              usrVarsErrorMsg:
                "Address hasn't interacted with Yiedly application or another error",
              fetchingUsrVars: false,
            });
          }
        }
      ...
      this.setState({
        usrVarsErrorMsg:
          "Algorand address is empty or already updating values! Please try entering a new Algorand address",
        fetchingUsrVars: false,
      });
    }
  }
  ...
  updateRewards() {
    if (this.state.yldyStaked && this.state.global) {
      ...
      if (yldyStakedNum > 0) {
        ...
        if (
          this.state.claimableAlgoRewards ||
      ...
      <>
        ...
        >
          ...
          <Row className="mt-5">
            <Col sm="12">
              <div className="text-center">
                <p className="lead">Total YLDY Staked</p>
                <h1>
                  <img
                    src={YLDY_ICON}
                    className="my-auto mr-1"
          ...
          <Row className="py-5">
            ...
            <Col lg="4">
              <div className="text-center">
                <p className="lead">ALGO available in to claim</p>
                <h1>
                  <img
                    className="my-auto mr-2"
                    src={ALGO_ICON}
              ...
              <div className="text-center my-5">
                <p className="lead">YLDY available to claim</p>
                <h1>
                  <img
                    className="my-auto mr-2"
                    src={YLDY_ICON}
            ...
            <Col lg="4">
              <div className="text-center">
                <p className="lead">Global Staking Shares (GSS)</p>
                <h1>
                  {this.state.global?.stakingShares
                    ? formatNumber(
              ...
              <div className="text-center my-5">
                <p className="lead">User Staking Shares (USS)</p>
                <h1>
            ...
            <Col lg="4">
              <div className="text-center">
                <p className="lead">Global Time (GT)</p>
                <h1>
                  {this.state.global?.time
              ...
              <div className="text-center my-5">
                <p className="lead">User Time (UT)</p>
                <h1>
                  {this.state.user
