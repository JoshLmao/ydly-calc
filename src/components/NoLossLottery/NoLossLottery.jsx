...
class NoLossLottery extends Component {
  ...
  componentDidMount() {
    ...
    getCurrentBlockTimestamp((blockId, blockTs) => {
      ...
      console.log(
        `Successfully got latest block (ID '${blockId}') with timestamp ${blockTs}`
      );
    });
  }
    ...
    if (this.state.algoAddress && !this.state.fetchingUsrVars) {
      ...
      getUserStateValues(
        ...
        (data) => {
          if (data) {
            console.log(
              `Successfully got user variables from application '${this.state.contractID}' on address '${this.state.algoAddress}'`
            );
            this.setState(
              {
                user: {
            ...
            this.setState({
              usrVarsErrorMsg:
                "Address hasn't interacted with Yiedly contract or another error",
              fetchingUsrVars: false,
            });
          }
        }
          ...
          <Row className="py-5">
            ...
            <Col lg="4">
              <div className="text-center">
                <p className="lead">Total ALGO (tickets) in Lottery</p>
                <h1>
                  <img
                    src={ALGO_ICON}
                    className="my-auto mr-1"
              ...
              <div className="text-center my-5">
                <p className="lead">Global Unlock Rewards</p>
                <h1>
                  <img
                    className="my-auto mr-2"
                    src={YLDY_ICON}
